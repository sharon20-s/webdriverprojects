...
// it ('should wait until text has been displayed', () => {
//     browser.waitUntil(async () => {
//         return await $("//a[@href='https://www.rajagiritech.ac.in/stud/ktu/student/']").getText() === 'Students Login »'
//     }, 5000, 'the text expected was not displayed within 5 seconds');
//     });
